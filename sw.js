const CACHE='jose-palacio-v1.9.0';
const FILES=['./','./index.html','./style.css','./game-v2.css','./questions.js','./app.js','./manifest.webmanifest','./assets/jose-jornada.png','./assets/logo-igreja.png','./assets/icon-192.png','./assets/icon-512.png'];
